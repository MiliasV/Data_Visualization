...
function createDropdown(csv_data){
  var menu = ["OriginCountries", "UniqueYear"]
...
function drawBarplot(Origin, Year){
...
var g = svg.append("g")
 ...
 //Get the data
 var countriesPerOriginPerYear = getcountriesPerOriginPerYear(data, Origin, Year)
