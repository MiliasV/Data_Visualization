...
/**
 *  Create a new svg and return it
 */
...
/**
 *  Draw a barplot.
 *  If flag is 0: the x-axis represents the countries where the refugees from $Origin fled to in $Year
 *  If flag is 1: the x-axis represents the countries from where the refugees came in $Origin and in $Year
 *  The y-axis shows the number of refugees
 */
